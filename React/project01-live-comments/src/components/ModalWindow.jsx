const ModalWindow = (props) => {
  let btnTitle = (props.editIdx===null) ? '작성' : '수정';
  let btnColor = (props.editIdx===null) ? 'primary' : 'warning';
  return (<>
    {/* 댓글 작성 Modal */}
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className={"btn btn-"+btnColor} onClick={props.saveComment} data-bs-dismiss="modal">{btnTitle}</button>
          </div>
        </div>
      </div>
    </div>
